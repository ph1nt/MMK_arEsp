...
#define SLEEP_DISPLAY 300  // 30 seconds to power off display
...
uint16_t keyMap[MATRIX_LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    {{KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO},
     ...
     {NUM, KC_LCTL, KC_LGUI, XXXXX, ENT_SFT, SPC_ALT, XXXXX, RAISE, KC_RGUI,
      LOWER}},
    // RAISE
    {{KC_ESC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
      KC_BSPACE},
     {KC_TAB, KC_NO, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT,
      KC_ENTER},
     {KC_GRV, KC_NO, KC_NO, KC_NO, KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_END,
      KC_BSLASH},
     {NUM, KC_LCTL, KC_LGUI, XXXXX, ENT_SFT, SPC_ALT, XXXXX, RAISE, KC_RGUI,
      LOWER}},
    // NUM
    {{KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0},
     {KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT,
      KC_ENTER},
     {KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_F13, KC_F14,
      KC_F15},
     {NUM, KC_LCTL, KC_LGUI, XXXXX, ENT_SFT, SPC_ALT, XXXXX, LOWER, KC_RGUI,
      LOWER}}};
/* TEMPLATE
{{KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO},
 {KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO},
